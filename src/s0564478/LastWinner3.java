...
public class LastWinner3 extends AI {
    ...
    private float goalRadius = 2.2f;
    private float decelerateRadius = 21.1f;
    private float throttleTime = 3.5f;

    // In Degree
    private float goalAngle = 1.4f;
    private float decelerateAngle = 66.1f;
    private float steerTime = 0.4f;
